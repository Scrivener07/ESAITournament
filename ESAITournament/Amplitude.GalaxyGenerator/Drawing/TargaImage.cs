...
namespace Paloma
{
    ...
    public class TargaImage : IDisposable
    {
        ...
        {
            get { return this.binaryImageData; }
        }
                ...
                if (this.objTargaHeader.ImageDataOffset > 0)
                {
                            ...
                            if ((RLEPacketType)intRLEPacketType == RLEPacketType.RUN_LENGTH)
                            {
                                ...
                                for (int i = 0; i < intRLEPixelCount; i++)
                                {
                                    ...
                                    if (intImageRowBytesRead == intImageRowByteSize)
                                    {
                                        ...
                                        this.row = new List<byte>(this.Header.Width * this.Header.BytesPerPixel);
                    ...
                    using (memoryStream = new MemoryStream())
                    {
                        ...
                        for (int i = 0; i < this.rows.Count; i++)
                        {
                            ...
                            byte[] brow = this.rows[i].ToArray();

                            // write the row bytes and padding bytes to the memory streem
                            memoryStream.Write(brow, 0, brow.Length);
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            this.binaryImageData = this.LoadImageBytes(binReader);
    ...
    public class TargaHeader
    {
        ...
        /// <summary>
        /// Gets the Color Map of the image, if any. The Color Map is represented by a list of Amplitude.GalaxyGenerator.Drawing.Color objects.
        /// </summary>
    ...
    static class Utilities
    {
        ...
        /// <returns>A Amplitude.GalaxyGenerator.Drawing.Color with a ARGB values read from the two given Bytes</returns>
        /// <remarks>
